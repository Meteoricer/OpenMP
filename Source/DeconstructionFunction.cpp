...
void delete_polymer_bundle(list<Polymer_Bundle>::iterator polymer_bundle_iter)
{
	...
	if(polymer_cluster_seq_iter!= polymer_bundle_iter->bundle_cluster_pointer_list.end())
		...
		//rule_parameters.polymer_diffusion_propensity = rule_parameters.polymer_diffusion_propensity - polymer_bundle_iter->available_polymer_diffusion_direction_sum;
		//rule_parameters.polymer_diffusion_propensity -= polymer_bundle_iter->available_polymer_diffusion_direction_sum;
