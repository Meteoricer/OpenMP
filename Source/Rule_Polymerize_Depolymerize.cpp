...
void TT_polymerize_vertical_plus()
{
	...
	for (int i = 0; i < 4; i++)
	{
		if (polymerize_polymer_iter->cluster_bundle_pointer->availabe_diffusion_direction[i] == true)
		{
			rule_parameters.polymer_diffusion_propensity -= calculate_diffusion_rate(polymerize_polymer_iter->cluster_bundle_pointer, i);
			polymerize_polymer_iter->cluster_bundle_pointer->availabe_diffusion_direction[i] = false;
			polymerize_polymer_iter->cluster_bundle_pointer->available_polymer_diffusion_direction_sum--;
		}
	...
	/*for (int i = 0; i < 4; i++)
	{
		if (polymerize_polymer_iter->cluster_bundle_pointer->availabe_diffusion_direction[i] == false)
		{
			polymerize_polymer_iter->cluster_bundle_pointer->availabe_diffusion_direction[i] = true;
			rule_parameters.polymer_diffusion_propensity += calculate_diffusion_rate(polymerize_polymer_iter->cluster_bundle_pointer, i);
...
void depolymerizeTT_plus()
{
	...
	for (int i = 0; i <= 3; i++)
	{
		if (depolymerize_polymer_cluster_iter->cluster_bundle_pointer->availabe_diffusion_direction[i] == true)
		{
			rule_parameters.polymer_diffusion_propensity -= calculate_diffusion_rate(depolymerize_polymer_cluster_iter->cluster_bundle_pointer, i);
			depolymerize_polymer_cluster_iter->cluster_bundle_pointer->availabe_diffusion_direction[i] = false;
			depolymerize_polymer_cluster_iter->cluster_bundle_pointer->available_polymer_diffusion_direction_sum--;
...
void depolymerizeTT_minus()
{
	...
	rule_parameters.depolymerization_statistics[depolymerize_polymer_cluster_iter->polymer_sequence.begin()->polymer_grid_pointer->row_position]++;
