...
public:
	...
	int column_num = 600;//600//600//150
	int row_num = 325;//563//800//200
	...
	double TT_annealing_rate = 0.01;//2500;
	double TD_annealing_rate = 0.0001;
	double fragmentation_multiplier = 10;
	double TT_fragmentation_rate = 0.01;//1;//8; #
	...
	double hydrolysis_rate = 0.66 / 60 * 6.9 / 0.66;
	double hydrolysis_multiplier = 1;
