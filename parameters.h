...
const double TT_polymerize_vertical_plus_rate=0.06;//0.05
const double TT_polymerize_vertical_minus_rate = 0.04;//0.05
...
const double TD_polymerize_vertical_plus_rate = 0.06;//0.05
const double TD_polymerize_vertical_minus_rate = 0.04;//0.05
...
const double TD_depolymerize_plus_rate = 1;//5;//20;//#5
const double DD_depolymerize_plus_rate = 10;//10;//40;//#5
const double TT_depolymerize_minus_rate = 0.155;//1;//8;//80#1
const double TD_depolymerize_minus_rate = 1;//5;//20;//#5
const double DD_depolymerize_minus_rate = 10;//10;//40;//#5
