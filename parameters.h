...
const double deanchoring_rate = 8;//4;//0.2;
...
const double diffusion_rate = 1000;//4000
const double emtpy_anchor_diffusion_rate = 1000;//0.1;
...
const double attatch_rate = 500;//100;//100//0.000001;
